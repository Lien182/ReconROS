...
## Installing
ReconROS uses an emulated docker container for the compilation of the application and building custom ROS message packages. 

Before we can get started, you have to install [Vivado](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/vivado-design-tools/archive.html) (tested with 2017.1) and [ROS2](https://docs.ros.org/en/dashing/Installation/Ubuntu-Install-Debians.html) (tested with Dashing)

you might have to install [concon](https://colcon.readthedocs.io/en/released/user/installation.html) too using
...
There are three sort demos available. 

1. ROS sort demo
2. ROS sort demo services
3. ROS sort demo actions

All three demos follow the same process to build server applications and client applications, except for ROS sort demo actions; in it client runs differently.
