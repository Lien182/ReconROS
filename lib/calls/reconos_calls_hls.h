...
<<generate for HWTOPICSPUB>>
#define ROS_PUBLISH_HWTOPIC_v1_timing_<<Name>>( <<Name>>, msg){\
...
<<generate for HWTOPICSPUB>>
#define ROS_PUBLISH_HWTOPIC_v1_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	write_section : { \
	__tmp_frame.last = 0; \
	<<=generate for Primitives=>>
...
<<generate for HWTOPICSSUB>>
#define ROS_READ_HWTOPIC_v1_timing_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	read_section : { \
...
<<generate for HWTOPICSSUB>>
#define ROS_READ_HWTOPIC_v1_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	read_section : { \
	<<=generate for Primitives=>>
		(<<Name>>).read(__tmp_frame); \
...
<<generate for HWTOPICSPUB>>
#define ROS_PUBLISH_HWTOPIC_v2_timing_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	write_section : { \
	__tmp_frame.user = 0; \
	__tmp_frame.last = 0; \
...
<<generate for HWTOPICSPUB>>
#define ROS_PUBLISH_HWTOPIC_v2_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	write_section : { \
	__tmp_frame.last = 0; \
	uint64_t tmp_1 = 0; \
...
<<generate for HWTOPICSSUB>>
#define ROS_READ_HWTOPIC_v2_timing_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	(<<Name>>).read(__tmp_frame); \
	(<<Name>>).read(__tmp_frame); \
	<<=generate for Primitives=>>
...
<<generate for HWTOPICSSUB>>
#define ROS_READ_HWTOPIC_v2_<<Name>>( <<Name>>, msg){\
	ap_axis<64,1,1,1> __tmp_frame; \
	<<=generate for Primitives=>>
		(<<Name>>).read(__tmp_frame); \
		(msg).<<name>> = __tmp_frame.data;  <<=end generate=>> <<=generate for Arrays_8bit=>> (<<Name>>).read(__tmp_frame); \
