...
elaborate()
{
  xelab --relax --debug typical --mt auto -L lib_pkg_v1_0_2 -L fifo_generator_v13_2_3 -L lib_fifo_v1_0_12 -L lib_srl_fifo_v1_0_2 -L lib_cdc_v1_0_2 -L axi_datamover_v5_1_20 -L axi_sg_v4_1_11 -L axi_dma_v7_1_19 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zycap xil_defaultlib.zycap xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim zycap -key {Behavioral:sim_1:Functional:zycap} -tclbatch cmd.tcl -protoinst "protoinst_files/zycap.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zycap.wdb xsim.dir)
