...
#start new
    ...
    endgroup
    set_property location {6 2456 2041} [get_bd_cells zycap_0]
    ...
    connect_bd_net [get_bd_pins zycap_0/s_axi_lite_aclk] [get_bd_pins reconos_clock_0/CLK0_Out]
    connect_bd_net [get_bd_pins zycap_0/axi_resetn] [get_bd_pins reset_0/interconnect_aresetn]
    startgroup
    ...
    endgroup
    set_property location {8 3312 2196} [get_bd_cells axi_interconnect_0]
    set_property -dict [list CONFIG.NUM_MI {1}] [get_bd_cells axi_interconnect_0]
    connect_bd_intf_net [get_bd_intf_pins zycap_0/M_AXI_MM2S] -boundary_type upper [get_bd_intf_pins axi_interconnect_0/S00_AXI]
    ...
    connect_bd_net [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins reconos_clock_0/CLK0_Out]
    connect_bd_net [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins reconos_clock_0/CLK0_Out]
    connect_bd_net [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins reconos_clock_0/CLK0_Out]
